...
class PartidosControllerTest < ActionController::TestCase
  ...
  test "should create partido" do
    assert_difference('Partido.count') do
      post :create, partido: { descricao: @partido.descricao, nome: @partido.nome, numero_politicos: @partido.numero_politicos, sigla: @partido.sigla }
    end
  ...
  test "should update partido" do
    patch :update, id: @partido, partido: { descricao: @partido.descricao, nome: @partido.nome, numero_politicos: @partido.numero_politicos, sigla: @partido.sigla }
    assert_redirected_to partido_path(assigns(:partido))
  end
